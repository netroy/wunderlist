...
wunderlist.menu = (function(undefined){
  ...
  function initMenuEvents(){
    ...
    $('a.credits', menuUl).click( dialogs.openCreditsDialog );
    $('a.backgrounds', menuUl).click( dialogs.openBackgroundsDialog );
    $('a.switchdateformat', menuUl).click( dialogs.openSwitchDateFormatDialog );
    $('a.deleteprompt', menuUl).click( dialogs.openDeletePromptDialog );
    $('a.sidebarposition', menuUl).click( dialogs.openSidebarPositionDialog );
